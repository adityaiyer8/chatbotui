...
AS $$
DECLARE
  project_url TEXT := 'https://pwmozpfeztwxjsliymka.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InB3bW96cGZlenR3eGpzbGl5bWthIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxNzQ0MDI4MiwiZXhwIjoyMDMzMDE2MjgyfQ.YvS1zrA428HVSR9QE1erH_R3JuCpiLueOK2VA6fAJ3o'; -- full access needed for http request to storage
